...
export default BookIcon = (props) => {
  return (
    <Svg
      ...
      {...props}
    >
      <Path fill='#BABABA' d='M0 2.75H35V29H0z' />
      <Path fill='#272727' d='M2.625 2.75H32.375V26.375H2.625z' />
      <Path
        ...
        strokeWidth={3}
      />
      <Path fill='#BABABA' d='M3.5 1H6.125V23.75H3.5z' />
      <Path fill='#BABABA' d='M28.875 1.875H31.5V23.75H28.875z' />
      <Path fill='#BABABA' d='M15.75 5.375H19.25V26.375H15.75z' />
      <Path fill='#BABABA' d='M2.625 2.75H3.5V5.375H2.625z' />
      <Path fill='#BABABA' d='M31.5 2.75H32.375V5.375H31.5z' />
      <Path
